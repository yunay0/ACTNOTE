...
export function canonicalMeetingAnalysisType(
  ...
  if (!key || key === "other" || key === "general" || key === "default") return "other";
    ...
    case "standup":
      return [
        { draftKey: "summary", title: "Summary", subtitle: "Progress and focus this period" },
        {
          draftKey: "blockers",
          title: "Blockers",
          subtitle: "(if any) Issues needing immediate attention",
        },
      ];
    case "other":
    default:
      return [
        { draftKey: "summary", title: "Summary", subtitle: "Meeting recap" },
        { draftKey: "key_topics", title: "Key Topics", subtitle: "Main themes discussed" },
...
export function mergeAnalysisExtrasIntoDraftDoc(
  ...
  setBlock(
    "key_topics",
    canon === "project_review" || canon === "one_on_one" || canon === "other",
  );
